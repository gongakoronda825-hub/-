...
| ファイル | 中身 |
| --- | --- |
| `zen-ghibli-tiktok.mp4` | 縦動画 1080x1920 / 30fps / 1分6秒。背景は緑一色、音声と字幕入り |
| `zen-ghibli-narration.mp3` | ナレーションのみ MP3 192kbps / 44.1kHz / モノラル |
| `zen-ghibli-narration.wav` | ナレーションのみ WAV 16bit / 24kHz / モノラル |
| `zen-ghibli-subtitles.srt` | 画面に出る文字のタイムコード（フック1枚＋字幕28枚） |
...
- 冒頭1.7秒は **「君たちはどう生きるか」** のフックだけを大きく出す（112px・金色）。
  同じ題名が2枚目の字幕に出てくるので、そこで席を譲って字幕に切り替わる
